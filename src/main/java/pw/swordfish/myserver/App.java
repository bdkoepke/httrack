...
import pw.swordfish.http.HttpResponse;
import pw.swordfish.http.HttpStatusCodes;
...
public class App implements Runnable {
	 ...
	 */
	public String notFound(URL url, Socket socket, Integer portNumber) throws MalformedURLException {
