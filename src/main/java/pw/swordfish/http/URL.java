...
public class URL implements Iterator<String>, Iterable<String> {
	...
	private LinkedList<String> pathLinkedList;
	private ListIterator<String> pathListIterator;
	private static Pattern hostnamePattern = Pattern.compile("http://([^/:]+)");;
	...
	public URL(String url) throws MalformedURLException {
		 ...
		 */
		pathLinkedList = new LinkedList<String>(Arrays.asList(fullPath.split("/")));
	 ...
	 */
	URL(String url, int portNumber) throws MalformedURLException {
		this(url);
